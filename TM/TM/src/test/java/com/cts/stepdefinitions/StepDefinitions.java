...
public class StepDefinitions {
	...
	public void i_click_on_Administration_Icon_and_I_enter_username_as_and_I_enter_password_as(String username, String password) {
	    // Write code here that turns the phrase above into concrete actions
	...
	public void i_should_access_to_the_portal_and_check_the_presence_of_AddTask_and_TaskList() {
		...
		//To check presence of Add task and TaskList
				...
				actualTitle1.click();
				LoginPage.ClickOnAdminIcon(driver);
	...
	public void i_click_on_Administration_Icon_and_I_enter_invalid_username_as_and_I_enter_valid_password_as(String username, String password) {
	    // Write code here that turns the phrase above into concrete actions
		HomePage.clickOnMyAccountIcon(driver);
  		LoginPage.enterInvalidUser(driver, username);
		LoginPage.enterValidPass(driver, password);
		LoginPage.clickOnLogin(driver);
	...
	public void it_should_display_an_error_message1() {
	    // Write code here that turns the phrase above into concrete actions
	    String actualText=driver.findElement(By.xpath("//td[contains(text(),'Login or Password is incorrect.')]")).getText();
	...
	public void i_click_on_Administration_Icon_and_I_enter_valid_username_as_and_I_enter_invalid_password_as(String username, String password) {
	    // Write code here that turns the phrase above into concrete actions
		HomePage.clickOnMyAccountIcon(driver);
  		LoginPage.enterValidUserName(driver, username);
		LoginPage.enteInvalidPassword(driver, password);
		LoginPage.clickOnLogin(driver);
	...
	public void i_click_on_Administration_Icon_and_I_enter_invalid_username_as_and_I_enter_invalid_password_as(String username, String password) {
	    // Write code here that turns the phrase above into concrete actions
		HomePage.clickOnMyAccountIcon(driver);
  		LoginPage.enterInValidUserName(driver, username);
		LoginPage.enteInvalidPass(driver, password);
		LoginPage.clickOnLogin(driver);
	}
	...
	public void i_click_on_the_Administration_Icon_and_I_enter_valid_username_as_and_I_enter_valid_password_as(String username, String password) {
		 HomePage.clickOnMyAccountIcon(driver);
	  		LoginPage.checkForLogOutuser(driver,username);
			LoginPage.checkForLogOutpass(driver,password);
			LoginPage.clickOnLogin(driver);
	...
	public void i_should_display_the_page_and_click_on_LogOut() {
		LoginPage.checkForLogOut(driver);
